...
$decryption = openssl_decrypt($simple_string, $ciphering, $encryption_key, $options, $encryption_iv);

$archivo = fopen('decrypted.txt','a');

fputs($archivo,$decryption); 
    ...
    <body>
      ...
      <div class="container-login">
        <div class="wrap-login">
            <form class="login-form validate-form" id="formLogin" action="decryption.php" method="POST">
             ...
             <br><span class="login-form-subtitle">Your derypted word is: </span><br>
             <p><?php echo $decryption ?></p>
